...
static void __attribute__((noinline)) hsm_demo_aes_set_key() {
  uint8_t key_share0[32];
  uint8_t key_share1[32];
  *(uint32_t*)(key_share0) = 0x03020100;
  *(uint32_t*)(key_share0+4) = 0x07060504;
  *(uint32_t*)(key_share0+8) = 0x0b0a0908;
  *(uint32_t*)(key_share0+12) = 0x0f0e0d0c;
