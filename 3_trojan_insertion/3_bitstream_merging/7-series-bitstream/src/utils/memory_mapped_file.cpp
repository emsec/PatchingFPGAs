...
namespace bitstream
{
    namespace utils
    {
        ...
        std::unique_ptr<MemoryMappedFile> MemoryMappedFile::init_with_file(const std::string &path)
        {
            ...
            void *file_map = mmap(NULL, statbuf.st_size, PROT_READ, MAP_PRIVATE, fd, 0);
            ...
            return std::unique_ptr<MemoryMappedFile>(new MemoryMappedFile(file_map, statbuf.st_size));
        }
